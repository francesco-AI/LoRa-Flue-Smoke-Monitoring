...
public class AWSIoT extends AppCompatActivity {
    ...
    private static final String CUSTOMER_SPECIFIC_ENDPOINT = "a3so13pvixexwp-ats.iot.eu-west-1.amazonaws.com";
    // Name of the AWS IoT policy to attach to a newly created certificate
    private static final String AWS_IOT_POLICY_NAME = "aws-iot-TTNIoTPolicy-1QFG1RZQMIULR";
    ...
    public List<String> subscriber = new LinkedList<String>();
                                ...
                                public void run() {
                                    try {
                                        ...
                                        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, LOG_TAG)
                                                ...
                                                .setContentTitle(topic + " Value: " + gas)
    ...
    public AWSIoT(Context context, String topic) {
